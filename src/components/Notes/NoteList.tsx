...
const NoteList: React.FC<Props> = ({ notes, isLoading }) => {
  ...
  return (
    <div className=' flex flex-col flex-1'>
      ...
      {
        isLoading ? <Loading /> :
          <div className='note_list items-start relative grid grid-cols-1 grid-rows-[auto] min-[450px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 sm:px-0 mt-5 sm:max-h-[72vh] sm:overflow-auto flex-1 sm:pr-2'>
            {
