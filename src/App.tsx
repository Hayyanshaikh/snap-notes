  ...
  return (
    <div className={`${isDarkMode ? "dark" : ""} h-screen`}>
      ...
      <div className="bg-white dark:bg-dark transition-all flex flex-col sm:flex-row  min-h-full">
        <div className='border-b h-full sm:fixed sm:border-b-0 sm:border-r transition-all bg-white dark:bg-darker dark:border-white/[10%] border-black/[20%] py-3 px-4'>
